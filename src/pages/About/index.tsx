        ...
        <>
            ...
            <PageContentLayout>
                <ContentSection>
                    ...
                    <Text>
                        Bitquran adalah aplikasi berbasis web yang menyajikan kitab suci Al-Qur'an secara digital dalam bentuk <i>website</i>. Dibangunnya aplikasi ini diharapkan dapat memunculkan ketertarikan untuk membaca Al-Qur'an karena dapat diakses dengan mudah.
                    </Text>
                    <Text>
                ...
                <ContentSection>
                    ...
                    <Text>
                        Sumber data seperti ayat-ayat, terjemahan, tafsir dan <i>murottal</i> disediakan melalui API oleh{' '}
                        <TextLink to="https://github.com/sutanlab/quran-api" target="_blank" rel="noreferrer"><b>SutanLab</b></TextLink>{' '}
                        yang mana data-datanya dihimpun dari berbagai sumber seperti{' '}
                        <TextLink to="https://quran.kemenag.go.id/" target="_blank" rel="noreferrer"><b>Kementerian Agama</b></TextLink>{' '}
                        untuk terjemahan dan tafsir ayat dalam bahasa Indonesia,{' '}
                        <TextLink to="https://api.alquran.cloud/" target="_blank" rel="noreferrer"><b>Quran Cloud</b></TextLink>{' '}
                        untuk ayat-ayat, meta data ayat, dan audio <i>murottal</i>,{' '}
                        <TextLink to="https://github.com/bachors/Al-Quran-ID-API" target="_blank" rel="noreferrer"><b>Al-Quran-ID-API</b></TextLink>{' '}
