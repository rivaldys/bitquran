...
describe('Head', () => {
    ...
    describe('meta tags', () => {
        it('creates a <meta> element in document.head', () => {
            render(<Head><meta name="description" content="Quran app" /></Head>)
        ...
        it('updates attributes on an existing element instead of creating a duplicate', () => {
            render(<Head><meta name="description" content="first" /></Head>)
            render(<Head><meta name="description" content="second" /></Head>)
        ...
        it('resolves uniqueness by the property attribute', () => {
            render(<Head><meta property="og:title" content="Bitquran" /></Head>)
    ...
    describe('link tags', () => {
        it('creates a <link> element resolved by rel', () => {
            render(<Head><link rel="canonical" href="https://bitquran.net" /></Head>)
    ...
    describe('cleanup', () => {
        it('removes dynamically created elements on unmount', () => {
            const { unmount } = render(<Head><meta name="test-cleanup" content="x" /></Head>)
        ...
        it('does not remove pre-existing elements on unmount', () => {
            ...
            const { unmount } = render(<Head><meta name="pre-existing" content="x" /></Head>)
            unmount()
    ...
    it('renders null — no DOM node added by the component itself', () => {
        const { container } = render(<Head><title>Test</title></Head>)
