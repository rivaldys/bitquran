...
const iconButtonStyle = cva('w-[25px] h-[25px] flex justify-center items-center border-none bg-transparent box-border transition duration-500 hover:cursor-pointer hover:opacity-55')
            ...
            {(audioButton || docButton) && (
                <div className="flex items-center">
                    {audioButton && (
                        ...
                        >
                            {audioButton.isPlaying ? (
                                <svg aria-hidden="true" className="h-[18px] fill-[#80cbc4]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    ...
                    {docButton && (
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-[22px] fill-none stroke-[#80cbc4]" viewBox="0 0 512 512">
