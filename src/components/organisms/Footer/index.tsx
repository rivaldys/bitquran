...
export default function Footer()
{
    ...
    return (
        <footer className="h-[75px] bg-[#f0f0f0] flex flex-col justify-center items-center box-border border-t-[1px] border-t-[#eaeaea] text-[#999999] text-xs leading-[19px] text-center">
