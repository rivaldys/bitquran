    ...
    return (
        <div className={containerStyle({ className: containerClassName })}>
            <div className="relative w-[40px] h-[40px] sm:w-[50px] sm:h-[50px] flex justify-center items-center fill-[#4caf50] mr-[15px]">
                ...
                <p className="absolute text-sm leading-[21px] sm:text-base sm:leading-[23px]">
                    {number}
                </p>
            </div>
            ...
            <Link to={href} className={cardStyle({ className })}>
                <div>
                    <p className="text-[rgb(117,117,117)] font-medium text-sm leading-[21px] sm:text-base sm:leading-[23px]">
                        {title}
                    </p>
                    <label className="text-[#999999] font-light text-xs leading-[19px] sm:text-sm sm:leading-[21px]">
                        {description}
                    </label>
                </div>
